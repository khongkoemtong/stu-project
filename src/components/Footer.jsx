    ...
    return(
      ...
      <div class="max-w-screen-xl mx-auto">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 lg:gap-12 gap-8 z-20 relative">
          <div>
            <h2 class="text-base font-medium text-white mb-6">Company</h2>
            <ul class="space-y-5">
              <li>
                <a href="javascript:void(0)" class="text-slate-400 hover:text-white text-[15px] inline-flex items-center transition-all"><svg
                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                  stroke-linecap="round" stroke-linejoin="round" class="inline mr-1.5 h-[18px] w-[18px] shrink-0">
          ...
          <div>
            <h2 class="text-base font-medium text-white mb-6">Products</h2>
            <ul class="space-y-5">
              <li>
                <a href="javascript:void(0)" class="text-slate-400 hover:text-white text-[15px] inline-flex items-center transition-all"><svg
                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
          ...
          <div>
            <h2 class="text-base font-medium text-white mb-6">Resources</h2>
            <ul class="space-y-5">
              <li>
                <a href="javascript:void(0)" class="text-slate-400 hover:text-white text-[15px] inline-flex items-center transition-all"><svg
                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
          ...
          <div>
            <h2 class="text-base font-medium text-white mb-6">Connect</h2>
            <ul class="space-y-5">
              <li>
                <a href="javascript:void(0)" class="text-slate-400 hover:text-white text-[15px] inline-flex items-center transition-all"><svg
                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
        ...
        <div class="flex flex-wrap sm:justify-between gap-6 relative z-20">
          <div class="flex space-x-5">
            <a href="javascript:void(0)" class="text-slate-400 hover:text-white text-[15px] inline-transition-all">
              <svg class="w-6 h-6 fill-gray-400 hover:fill-white" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a href="javascript:void(0)" class="text-slate-400 hover:text-white text-[15px] inline-transition-all">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="fill-gray-400 hover:fill-white w-6 h-6"
                viewBox="0 0 24 24">
          ...
          <p class="text-slate-400 text-sm">© ReadymadeUI. All rights reserved.
          </p>
        </div>
      </div>
